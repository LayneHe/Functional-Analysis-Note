...
1. 证明**存在性**
   ...
   -  若 $M\not=H$，我们讨论 $x_0\in M\backslash H \subset H$ 由射影定理
      ...
      ![Image](https://pic4.zhimg.com/80/v2-da4365f563f8f0e471ef1ddce2e7bb16.png)
...
3. 证明 **等范性**
   ...
   **注意**：这个证明实际上给出了我们如何计算算子范数的通常做法。
   ...
   在证明$\mathrm{Riesz}$ 表现定理之前，对引例提出了怎么求算子范数的问题，对等范性的证明正是求算子范数的一个模版。

   可以参照 1.7.2 节的例题，对比一下是不是这样的过程。
